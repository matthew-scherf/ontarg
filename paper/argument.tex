...
\textbf{Two tracks.}
\emph{Limit:} L1--L3 and Th.\,1--4 in \lf{lean/Becoming.lean}; Th.\,5--7, $P$, and
independence in \lf{lean/Obstruction.lean}; limit paper \lf{paper/undeniability.tex}.
\emph{Cut:} absolute\,:=\,cut\,:=\,$\lnot$ (self-dual excluding law); absolute models are
runs --- \lf{lean/Cut.lean}, \lf{paper/cut.tex}. The cut track does not derive $P$ from
claims; it types absolute status as $\mathrm{Run}(\lnot)$.\\[2pt]
All files: Lean~4, prelude only, no imports, no axioms.}
\end{document}
